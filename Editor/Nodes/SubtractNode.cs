...
{
    public SubtractNode(Vector2 position) : base(position, "Subtract")
    {
        Inputs.Add(new Port("Height", PortType.Heightmap));
        Inputs.Add(new Port("Subtract", PortType.Heightmap));
        Outputs.Add(new Port("Height", PortType.Heightmap));
    }

    protected override Color HeaderColor => new Color(0.45f, 0.20f, 0.20f, 1f); // red
